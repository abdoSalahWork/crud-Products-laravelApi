                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('product.update',[$product])}}" method="POST">
                                            ...
                                            <label for="ProductDescription">ProductDescription:</label>
                                            <textarea name="productDescription" name="ProductDescription" id="ProductDescription" class="form-control mb-4" cols="30" rows="5">{{$product->productDescription}}</textarea>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                <button type="button" class="btn btn-info">Update Change</button>
                                            </div>
                                        </form>
                                    </div>
